class InsertInOrder
{
	...
	// Merges two arrays into destination array 
	// returns the destination array
	static int [] merge_arrays(int [] a, int [] b)
	{
	...
	static String show_array(int [] a)
	{
	...
	static void insert_in_order(int [] ordered, int value_to_insert)
	{
